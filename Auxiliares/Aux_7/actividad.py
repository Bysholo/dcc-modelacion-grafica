...
P1 = np.array([[0, 0, -5]]).T
P2 = np.array([[0, 0, 5]]).T
T1 = np.array([[90, 0, 0]]).T
T2 = np.array([[90, 0, 0]]).T
...
def on_draw():
    ...
    transformPurple = tr.translate(HermiteCurve[controller.step,1],HermiteCurve[controller.step,2],HermiteCurve[controller.step,0])
